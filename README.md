...
- **Option 1 — Public demo (deployed on Render)**: use the deployed site at `https://socket-group-32.onrender.com/`.
...
4. At the project root, start the server:

```
npm run dev
```

5. Enter the locally demo site in your browser: `http://localhost:3000/`
